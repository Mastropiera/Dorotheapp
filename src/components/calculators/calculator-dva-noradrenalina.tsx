...
import { Droplet, HelpCircle, Weight, Syringe, Sigma, RefreshCcw, Info } from 'lucide-react';
...
const DVANoradrenalinaCalculator: React.FC = () => {
  ...
  return (
    <Card className="w-full max-w-xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center"><Syringe className="mr-2 h-6 w-6 text-orange-500" />Cálculo de Noradrenalina (Norepinefrina)</CardTitle>
        <CardDescription>
          Vasopresor potente con acción predominante alfa-adrenérgica. Produce vasoconstricción y aumento de la presión arterial con leve efecto inotrópico. Indicada en shock con hipotensión refractaria.
        </CardDescription>
        <p className="text-xs text-muted-foreground pt-1">Presentación: Ampolla de 4mg/4ml</p>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form className="space-y-6">
            <Card className="p-4 bg-muted/30">
                ...
                <CardContent className="p-0 grid grid-cols-2 gap-4">
                    {renderInputField("drogaMg", "Fármaco (Noradrenalina)", "mg")}
        ...
        <div className="text-xs text-muted-foreground space-y-2">
            ...
            <ul className="list-disc list-inside pl-4">
             ...
             <p className="italic">
                Verifique siempre los cálculos y protocolos institucionales. Esta herramienta es una ayuda y no reemplaza el juicio clínico. Las diluciones estándar para Noradrenalina suelen ser 4mg u 8mg en 250ml.
            </p>
        </div>
      </CardContent>
    </Card>
...
export default DVANoradrenalinaCalculator;