...
const DVADopaminaCalculator: React.FC = () => {
  ...
  return (
    <Card className="w-full max-w-xl mx-auto">
      <CardHeader>
        <CardTitle className="flex items-center"><Syringe className="mr-2 h-6 w-6 text-blue-500" />Cálculo de DVA: Dopamina</CardTitle>
        <CardDescription>
          Calcula la velocidad de infusión (ml/h) o la dosis (µg/kg/min) para Dopamina.
        </CardDescription>
        <p className="text-xs italic text-muted-foreground pt-2">
            Catecolamina, vasopresor, inotropo.
        </p>
        <p className="text-xs text-muted-foreground pt-1">Presentación: Ampolla de 5 ml: 200 mg</p>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form className="space-y-6">
            <Card className="p-4 bg-muted/30">
                ...
                <CardContent className="p-0 grid grid-cols-2 gap-4">
                    {renderInputField("drogaMg", "Fármaco (Dopamina)", "mg")}
        ...
        <div className="text-xs text-muted-foreground space-y-2">
            ...
            <ul className="list-disc list-inside pl-4">
             ...
             <p className="italic">
                Verifique siempre los cálculos y protocolos institucionales. La dilución estándar para Dopamina es de 400mg en 250ml.
            </p>
        </div>
      </CardContent>
    </Card>
...
export default DVADopaminaCalculator;