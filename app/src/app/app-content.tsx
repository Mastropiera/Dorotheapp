...
export default function AppContent() {
  ...
  const handleDateSelect = useCallback((date?: Date) => {
    if (date) {
      ...
      // La carga de eventos de Google ahora se hace al cambiar de mes
      // o al conectar la cuenta
  ...
  return (
    ...
    >
      ...
      <DialogsSection
        ...
        // Todos los props de diálogos (incluye selectedDate, isSheetOpen, etc.)
        {...dialogsHook}
        // Props específicos de cada hook
        ...
        isLoadingWelcomeEvents={dialogsHook.isLoadingWelcomeEvents} // Pass this down
      />
